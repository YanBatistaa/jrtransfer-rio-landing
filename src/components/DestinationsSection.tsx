...
export function DestinationsSection() {
  ...
  return (
    <section id="destinos" className="w-full py-12 md:py-24 lg:py-32 bg-background/50">
      <div className="container px-4 md:px-6">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">
          {t("destinations.title")} {/* 3. Usar a chave de tradução */}
        </h2>
        <Carousel
          opts={{
            align: "start",
                  ...
                  <Card className="overflow-hidden border-0 shadow-lg">
                    <CardContent className="relative flex aspect-[4/5] items-end justify-center p-0">
                      <img
                        ...
                        alt={`Imagem do destino ${destination.name}`}
